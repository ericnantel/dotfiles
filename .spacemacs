...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner "~/.spacemacs.d/gengar.png"
   ...
   dotspacemacs-themes '((doom-rose-pine-moon :location local)
                         spacemacs-dark
                         spacemacs-light)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (add-to-list 'custom-theme-load-path "~/.spacemacs.d/local/doom-rose-pine-moon")
  )
...
before packages are loaded."
  ...
  ;;calendar in agenda/holidays.org
  ;;https://jmonlong.github.io/Hippocamplus/org-mode

  ;;org-mode
  (setq org-directory (concat home-directory "/OrgFiles"))
  ...
  (setq org-capture-templates
        '(("p" "[p]ersonal" entry (file+headline (lambda () (concat org-directory "/agenda/personal.org")) "Personal")
          ...
          ("w" "[w]ork" entry (file+headline (lambda () (concat org-directory "/agenda/work.org")) "Work")
           "* TODO %?\n %U\n" :empty-lines 1)
          ("c" "[c]ourses (school)" entry (file+headline (lambda () (concat org-directory "/agenda/courses.org")) "Courses")
           "* TODO %?\n %U\n" :empty-lines 1)
          ...
          ("j" "Pro[j]ect (school)" entry (file+headline (lambda () (concat org-directory "/agenda/projects.org")) "Projects")
           "* TODO %?\n %U\n" :empty-lines 1)
          ("a" "[a]dd contacts" entry (file+headline (lambda () (concat org-directory "/contacts.org")) "Contacts")
...
:END:" :empty-lines 1)))
  ...
  (setq org-todo-keyword-faces
        '(("DONE" . (:background "#403d52" :foreground "white" :weight bold))
