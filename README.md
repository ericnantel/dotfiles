...
- clang-format (on MacOS for Vim, available with clang-tools-extra on OpenBSD)
- clang, clang-format (on GNU/Linux, available with clang-tools-extra on OpenBSD)
...
- xdg-desktop-portal-hyprland (recommended for obs in hyprland)
- xdg-desktop-portal-wlr (recommended for obs in sway)
- pipewire (recommended for obs in hyprland)
- wf-recorder (optional - wayland recorder)
